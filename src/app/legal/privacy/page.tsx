    ...
    <div className="mx-auto max-w-2xl px-6 py-12">
      ...
      <div className="space-y-6 text-body text-foreground">
        <section>
          ...
          <p>
            PreWaitlist (&quot;we,&quot; &quot;us,&quot; or &quot;our&quot;)
            provides a waitlist management platform. This Privacy Policy
            explains how we collect, use, and protect information when you use
            our service. By using PreWaitlist, you agree to the collection and
        ...
        <section>
          ...
          <ul className="mt-2 list-disc pl-5 space-y-1">
            <li>
              <strong>Email addresses</strong> — collected when someone joins a
              waitlist
            </li>
            <li>
              <strong>IP addresses</strong> — collected at signup for fraud
              prevention and GDPR compliance
            </li>
            <li>
              <strong>Account information</strong> — your name and email when
              you create a founder account
            </li>
            <li>
              <strong>Usage data</strong> — pages visited, actions taken within
              the platform
            </li>
          </ul>
        </section>
        ...
        <section>
          ...
          <ul className="mt-2 list-disc pl-5 space-y-1">
            ...
            <li>
              Send transactional emails (confirmation, position updates,
              milestones)
            </li>
            <li>
              Send broadcast emails that founders compose and choose to deliver
            </li>
        ...
        <section>
          ...
          <p>
            Your data is stored in PostgreSQL databases hosted by Supabase. We
            implement industry-standard security measures including encryption
            at rest and in transit. We do not store payment card information
            directly.
          </p>
        </section>
        ...
        <section>
          ...
          <ul className="mt-2 list-disc pl-5 space-y-1">
            <li>
              <strong>Resend</strong> — email delivery service. Your email
              address is shared with Resend solely for the purpose of delivering
              emails you have consented to receive.
            </li>
            <li>
              <strong>Supabase</strong> — database and authentication provider
            </li>
            <li>
              <strong>Vercel</strong> — hosting and infrastructure provider
            </li>
          </ul>
          <p className="mt-2">
        ...
        <section>
          ...
          <ul className="mt-2 list-disc pl-5 space-y-1">
            ...
            <li>
              <strong>Unsubscribe</strong> — opt out of any email communications
              at any time
            </li>
          </ul>
          <p className="mt-2">
        ...
        <section>
          ...
          <p>
            PreWaitlist uses essential cookies for authentication and session
        ...
        <section>
          ...
          <p>
            PreWaitlist is not intended for use by children under 13. We do not
        ...
        <section>
          ...
          <p>
            ...
            at{" "}
            <a
              href="mailto:privacy@prewaitlist.com"
