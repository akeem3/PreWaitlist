...
| Tier     | Current (at execution)  | Final (founder override 2026-09-25) |
| -------- | ----------------------- | ----------------------------------- |
| Hot      | `bg-accent` (post-15.4) | **`bg-status-hot`**                 |
...
| File                                                 | Change                                                |
| ---------------------------------------------------- | ----------------------------------------------------- |
| `components/dashboard/warmth-panel.tsx`              | Hot bar → `bg-status-hot`                             |
...
| `src/app/dashboard/client.tsx`                       | Hot number → `text-status-hot`                        |
| `src/app/dashboard/warmth/client.tsx`                | Badge + summary → `bg-status-hot` / `text-status-hot` |
...
| AC                         | Status | Evidence                                                                                                                                                                                                                                                                                                                                                                                                                            |
| -------------------------- | ------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| AC1 Hot bar token color    | ✅     | `warmth-panel.tsx` — both Hot bars `color="bg-status-hot"` (free `:95`, pro `:127`); Warm/Cold/Unscored unchanged; zero Hot `bg-accent` in warmth surfaces (sweep-verified; founder override 2026-09-25)                                                                                                                                                                                                                            |
...
| AC6 Hot number token color | ✅     | `dashboard/client.tsx:453` + `warmth/client.tsx:150` → `text-status-hot`; badge hot → `bg-status-hot text-white` (`warmth/client.tsx:49`); marketing `difference-section.tsx` intentionally untouched                                                                                                                                                                                                                               |
