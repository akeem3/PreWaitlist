...
| Warmth tracking        | Hot/Warm/Cold per subscriber, email open tracking via Resend webhooks (elevated from v1.1 — required for warmth accuracy), warmth filter in subscriber list, warmth-segmented broadcast                                    |
