...
| 12  | ✅  | Hot bar `bg-status-hot` (→ 15.4 aligned to `bg-accent` green → **founder reverted to `bg-status-hot` everywhere 2026-09-25**; bar + badge + numbers all status tokens now)                                                       | `warmth-panel.tsx:95/:127` vs `warmth/client.tsx:49` |
...
- `components/dashboard/warmth-panel.tsx` — 4-bar distribution (**hot bar/badge/numbers all `bg-status-hot` since founder fix 2026-09-25**)
