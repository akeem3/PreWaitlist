...
| AC                | Status | Evidence                          |
| ----------------- | ------ | --------------------------------- |
| AC1 Story 11.1    | ❌     | Still has reply/visit in AC2      |
| AC2 Story 11.2    | ❌     | Still subscriber-table wording    |
| AC3 Story 11.5    | ❌     | AC1/AC3 contradiction remains     |
| AC4 Story 11.6    | ❌     | Still 400-era / missing file list |
| AC5 Vision opens  | ❌     | :150 etc. unchanged               |
| AC6 MEMORY        | ❌     | No Epic 15 block                  |
| AC7 Audit §2      | ❌     | Findings not marked fixed         |
| AC8 Epic 11 index | ❌     | Status drift remains              |
| AC9 Lint + build  | ⏳     | —                                 |
