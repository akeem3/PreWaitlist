...
| AC4 Story 11.6    | ✅     | AC1 = **401** for missing/failed signature; AC3–AC5 name 15.5 files; 11.0 status block (401s, svix pre-check, multi-waitlist fix, `after()`, 8-value CHECK) + 11.3 Dev Notes = 15.4 outcomes               |
